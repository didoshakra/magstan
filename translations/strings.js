...
const strings = {
  ...
  pl: {
    ...
    headerMenu_titleSite: "Test Site",
    headerMenu_toggleTheme: "Zmień motyw (jasny / ciemny)",
    headerMenu_changeLanguage: "Zmień język",
  ...
  uk: {
    ...
    headerMenu_toggleTheme: "Змінити тему (світлу / темну)",
    headerMenu_openDrawer: "Відкрити головну навігацію",
    headerMenu_changeLanguage: "Змінити мову",
