...
const strings = {
  en: {
    ...
    header_titleShops: "Shops",
    header_titleServices: "Services",
    header_titlePromotions: "Promotions",
    header_titleAboutME: "About us",
    ...
    // pageHome_aboutPage: `Shop chain Stanislavsky.`,
  ...
  pl: {
    ...
    header_titleShops: "Sklepy",
    header_titleServices: "Usługi",
    header_titlePromocje: "Promocje",
    header_titleAboutME: "O nas",
    header_titleAppIcon: "Add_ons",
    header_titleHomeIcon: "Główna",
    header_titleSite: "Test Site",
  ...
  uk: {
    ...
    header_titleShops: "Магазини",
    header_titleServices: "Послуги",
    header_titlePromotions: "Акції",
    header_titleAboutME: "Про нас",
    header_titleHomeIcon: "На головну",
    header_titleSite: "Станіславський",
    header_toggleTheme: "Змінити тему (світлу / темну)",
